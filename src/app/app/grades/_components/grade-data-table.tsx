...
type GradeDataTableProps = {
  data: Grade[]
}

export function GradeDataTable({ data }: GradeDataTableProps) {
  ...
  const columns: ColumnDef<Grade>[] = [
    {
      ...
      cell: ({ row }) => <div className="px-6">{row.getValue('serie')}</div>,
    },
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => handleDeleteGrade(grade)}>
                Delete
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
